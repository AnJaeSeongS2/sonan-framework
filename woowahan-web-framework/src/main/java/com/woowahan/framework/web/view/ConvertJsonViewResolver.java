 ...
 */
public class ConvertJsonViewResolver {
//
...
//
//    @Override
//    public Object resolve(ResponseMessage beforeResolve, HttpServletRequest req, HttpServletResponse resp) throws FailedViewResolveException {
//        try {
