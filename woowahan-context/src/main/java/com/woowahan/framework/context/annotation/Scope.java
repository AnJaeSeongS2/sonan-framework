 ...
 * @see com.woowahan.framework.context.bean.Scope
...
public @interface Scope {
    com.woowahan.framework.context.bean.Scope value() default com.woowahan.framework.context.bean.Scope.SINGLETON;
}
