...
import org.sonan.framework.context.annotation.BeanRegistrable;
...
import org.sonan.util.classloader.FirstChildOnBasePackageClassLoader;
...
public class BeanDefinitionHolder {
    ...
    private static final String SYSTEM_BASE_PACKAGE = "org.sonan.framework";
    ...
    // system측에서 등록해 사용하는 beanMetaFinder. basePackage가 org.sonan.framework 이다.
    ...
    private BeanDefinition genBeanDefinition(Class<?> beanClass) throws BeanDefinitionNotGeneratedException {
        try {
            ...
            for (Annotation anno : beanClass.getDeclaredAnnotations()) {
                ...
                if (anno.annotationType() == org.sonan.framework.context.annotation.Scope.class) {
                    beanScope = ((org.sonan.framework.context.annotation.Scope) anno).value();
                }
            }
